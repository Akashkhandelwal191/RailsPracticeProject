...
ActiveRecord::Schema[7.0].define(version: 2023_09_28_060614) do
  ...
  create_table "products_wish_lists", id: false, force: :cascade do |t|
    ...
    t.index ["product_id", "wish_list_id"], name: "by_product_and_wish_list", unique: true
  end
